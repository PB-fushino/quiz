function answer(num){
        ...
        // alert(name);
        $.ajax({
            url : 'http://3.112.46.141:8080/answer',
            method : "POST",
            data : {
                id : 1,
                uid : id,
...
function checkTime(num){
    // alert(num);
    $.ajax({
        url : 'http://3.112.46.141:8080/checkTime',
        method : "POST",
        data : {
            qid :num
        }
...
function login() {
    ...
    $.ajax({
        url : 'http://3.112.46.141:8080/login',
        method : "POST",
        data : {
            name : name
        }
...
function quiz(){
    ...
    var domain = "http://3.112.46.141:8080/quiz";
...
function launchquiz(){
    ...
    var domain = "http://3.112.46.141:8080/launchquiz";
...
function winner(){
    var domain = "http://3.112.46.141:8080/winner";
    $(function(){
        $.ajax({
            url : domain,
            type : 'GET'
...
function checkquiz(){
    var domain = "http://3.112.46.141:8080/checkquiz";
    $(function(){
        $.ajax({
            url : domain,
            type : 'GET'
...
function wait() {
    $.ajax({
        url : 'http://3.112.46.141:8080/wait',
        method : "POST",
        data : {
            name : "fushino",
        }
...
function check_quiz_status_pc() {
    $.ajax({
        url : 'http://3.112.46.141:8080/quiz_status',
        method : "GET",
...
function check_quiz_status_answer_pc() {
    var qid = localStorage.getItem("qid");
    $.ajax({
        url : 'http://3.112.46.141:8080/quiz_status_answer',
        method : "POST",
        data : {
            qid : qid
        },
...
function checkanswer() {
    var qid = localStorage.getItem("qid");
  $.ajax({
      url : 'http://3.112.46.141:8080/checkanswer',
      method : "POST",
      data : {
          qid : qid
      },
...
function change_status(statusNumber,quizNumber) {
    ...
    //  alert(quizNumber);
     alert(status);
    $.ajax({
        url : 'http://3.112.46.141:8080/change_status',
        method : "POST",
        data : {
            qid: quizNumber,
            status: status
