function answer(num){
        ...
        // alert(name);
        $.ajax({
            url : 'http://api.happywedding-manae-shinji.tk/answer',
            method : "POST",
            data : {
                id : 1,
                uid : id,
...
function checkTime(num){
    // alert(num);
    $.ajax({
        url : 'http://api.happywedding-manae-shinji.tk/checkTime',
        method : "POST",
        data : {
            qid :num
        }
...
function login() {
    ...
    $.ajax({
        url : 'http://api.happywedding-manae-shinji.tk/login',
        method : "POST",
        data : {
            name : name
        },
...
function quiz(){
    ...
    var domain = "http://api.happywedding-manae-shinji.tk/quiz";
...
function launchquiz(){
    ...
    var domain = "http://api.happywedding-manae-shinji.tk/launchquiz";
    ...
    $(function(){
        $.ajax({
            ...
            localStorage.setItem("qid",data.id);
                    ...
                    $('.problem').append
                    ('<p　id="'+data.id+'">問題：'+data.problem+'</p>');
                    $('.a').attr('src', '/assets/images/sample/images/images/images/'+data.id+'-a.jpg');
                    $('.b').attr('src', '/assets/images/sample/images/images/images/'+data.id+'-b.jpg');
                    $('.c').attr('src', '/assets/images/sample/images/images/images/'+data.id+'-c.jpg');
                    $('.d').attr('src', '/assets/images/sample/images/images/images/'+data.id+'-d.jpg');
...
function winner(){
    var domain = "http://api.happywedding-manae-shinji.tk/winner";
    $(function(){
        $.ajax({
            url : domain,
            type : 'GET',
...
function checkquiz(){
    var domain = "http://api.happywedding-manae-shinji.tk/checkquiz";
    $(function(){
        $.ajax({
            url : domain,
            type : 'GET'
...
function wait() {
    $.ajax({
        url : 'http://api.happywedding-manae-shinji.tk/wait',
        method : "POST",
        data : {
            name : "fushino",
        },
...
function check_quiz_status_pc() {
    $.ajax({
        url : 'http://api.happywedding-manae-shinji.tk/quiz_status',
        method : "GET",
...
function check_quiz_status_answer_pc() {
    var qid = localStorage.getItem("qid");
    $.ajax({
        url : 'http://api.happywedding-manae-shinji.tk/quiz_status_answer',
        method : "POST",
        data : {
            qid : qid
        },
...
function checkanswer() {
    var qid = localStorage.getItem("qid");
  $.ajax({
      url : 'http://api.happywedding-manae-shinji.tk/checkanswer',
      method : "POST",
      data : {
          qid : qid
      },
...
function change_status(statusNumber,quizNumber) {
    ...
    //  alert(quizNumber);
     alert(status);
    $.ajax({
        url : 'http://api.happywedding-manae-shinji.tk/change_status',
        method : "POST",
        data : {
            qid: quizNumber,
            status: status
